...
#define MERKAVA_SPG_KZG(CAMONET) \
        textures[] = {\
          ...
          QPATHTOEF(vehicle_textures,data\Merkava\Merkava_SPG_KZG_CO.paa),\
          QPATHTOEF(vehicle_textures,data\common\Turret_rcws_KZG_CO.paa),\
          CAMONET\
        };
...
#define MERKAVA_MLRS_KZG(CAMONET) \
        textures[] = {\
          QPATHTOEF(vehicle_textures,data\Merkava\Merkava_body_KZG_CO.paa),\
          QPATHTOEF(vehicle_textures,data\Merkava\Merkava_MLRS_KZG_CO.paa),\
          CAMONET\
        };
