...
class GCLASS(Typhoon_Fuel): O_Truck_03_fuel_F {
    ...
    class TextureSources {
        ...
        class Maze {
            displayName = "Maze";
            textures[] = {
                QPATHTOEF(vehicle_textures,data\typhoon\typhoon_01_JSN_CO.paa),
                QPATHTOEF(vehicle_textures,data\typhoon\typhoon_02_JSN_CO.paa),
                QPATHTOEF(vehicle_textures,data\typhoon\typhoon_cargo_JSN_CO.paa),
            };
            factions[] = {};
        };
    };
    ...
    class TextureSources {
        ...
        class Maze {
            ...
            textures[] = {
                QPATHTOEF(vehicle_textures,data\typhoon\typhoon_01_JSN_CO.paa),
                QPATHTOEF(vehicle_textures,data\typhoon\typhoon_02_JSN_CO.paa),
                QPATHTOEF(vehicle_textures,data\typhoon\typhoon_ammo_JSN_CO.paa),
            };
            factions[] = {};
        };
