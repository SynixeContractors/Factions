...
#define T100_MAZE(CAMONET) \
            textures[] = {\
              QPATHTOEF(vehicle_textures,data\t100\t100_body_JSN_CO.paa),\
              QPATHTOEF(vehicle_textures,data\t100\t100_turret_JSN_CO.paa),\
              QPATHTOEF(vehicle_textures,data\t100\t100_addons_JSN_CO.paa), \
              CAMONET\
            };
#define T100_CDF(CAMONET) \
            textures[] = {\
              QPATHTOEF(vehicle_textures,data\t100\t100_body_CDF_CO.paa),\
              QPATHTOEF(vehicle_textures,data\t100\t100_turret_CDF_CO.paa),\
              QPATHTOEF(vehicle_textures,data\t100\t100_addons_CDF_CO.paa),\
              CAMONET\
            };
