...
#define MERKAVA_KZG(CAMONET) \
        textures[] = {\
          QPATHTOEF(vehicle_textures,data\Merkava\Merkava_body_KZG_CO.paa),\
          QPATHTOEF(vehicle_textures,data\Merkava\Merkava_turret_KZG_CO.paa),\
          CAMONET\
        };
...
class GCLASS(Merkava_TUSK): B_MBT_01_TUSK_F {
    ...
    class TextureSources {
      ...
      class KZG_01 {
        displayName = "Khaybaran (Desert Net)";
        MERKAVA_TUSK_KZG(NET_DESERT)
        factions[] = {};
      };
      class KZG_01_green {
        displayName = "Khaybaran (Green Net)";
        MERKAVA_TUSK_KZG(NET_GREEN)
        factions[] = {};
      };
      class KZG_01_jungle {
        displayName = "Khaybaran (Jungle Net)";
        MERKAVA_TUSK_KZG(NET_JUNGLE)
        factions[] = {};
      };
      class KZG_01_winter {
        displayName = "Khaybaran (Winter Net)";
        MERKAVA_TUSK_KZG(NET_WINTER)
        factions[] = {};
      };
