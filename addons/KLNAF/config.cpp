...
class CfgPatches {
    class ADDON {
        ...
        units[] = {
            ...
            QCLASS(SYN_O_KLNAF_A_Teamleader),
            QCLASS(SYN_O_KLNAF_B_Teamleader),
            QCLASS(SYN_O_KLNAF_B_Radioman),
            QCLASS(SYN_O_KLNAF_A_Rifleman),
            QCLASS(SYN_O_KLNAF_B_Rifleman),
            QCLASS(SYN_O_KLNAF_A_Rifleman_2),
            QCLASS(SYN_O_KLNAF_A_Rifleman_3),
            QCLASS(SYN_O_KLNAF_B_Rifleman_MAT),
            QCLASS(SYN_O_KLNAF_B_Rifleman_HAT),
            QCLASS(SYN_O_KLNAF_B_Rifleman_AA),
