    ...
    class ADDON {
        ...
        units[] = {
            @For(Identities)
                ...
                QCLASS2(Van_Service,NATION),
                QCLASS2(Van_Transport,NATION),
                QCLASS2(Van_Ambulance,NATION),
                QCLASS2(Van_Cargo,NATION),
                QCLASS2(Hatchback,NATION),
                QCLASS2(Hatchback_Sport,NATION),
                QCLASS2(SUV,NATION),
                QCLASS2(Tractor,NATION),
                QCLASS2(Jeep,NATION),
                QCLASS2(Offroad,NATION),
                QCLASS2(Offroad_Covered,NATION),
