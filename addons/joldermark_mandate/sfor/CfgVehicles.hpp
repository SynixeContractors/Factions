...
class CLASS2(SIDE,Base): PCLASS2(SIDE,Base) {
    ...
    #undef TEMPLATE_SIDE
        ...
        displayName = "sfor Base Army Garrison";
        editorSubcategory = QGCLASS(sfor);
        ...
        @Facewear({
        "Aegis_G_Armband_BLU_F": 1,
        "Aegis_G_Armband_BLU_alt_F": 1,
        "Aegis_G_Armband_IND_alt_F": 1,
    ...
    class CLASS2(SIDE,Rifleman): CLASS2(SIDE,Base) {
        ...
        @Headgear({
            "synixe_MilCap_sfor": 1,
            "synixe_MilCap_tachs_sfor": 1,
            "synixe_MilCap_nohs_sfor": 1,
            "synixe_Booniehat_sfor": 1,
            "synixe_Booniehat_sfor_hs": 1,
            "synixe_HelmetLuchnik_brown2_sfor_F": 1,
            "synixe_HelmetLuchnik_brown_sfor_F": 1,
            "synixe_HelmetLuchnik_green2_sfor_F": 1,
            "synixe_HelmetLuchnik_green_sfor_F": 1,
        ...
        @Vests({
            "variants": {
                "synixe_PlateCarrier_sfor": 1,
                "synixe_PlateCarrier2_sfor": 1,
                "synixe_PlateCarrier4_sfor": 1,
                "synixe_PlateCarrierIA1_sfor": 1,
                "synixe_PlateCarrier3_sfor": 1,
            },
            "magazines": {
                "SmokeShell": 2,
            },
